...
export const ChartController = () => {
  ...
  const chartHeight = Math.max(Math.round(Math.min(screenHeight * 0.34, 340)), 280);
  ...
  return (
    <ScrollView
      ...
      contentContainerClassName="px-4 py-3 gap-3 pb-28"
      showsVerticalScrollIndicator={false}>
        <View className="rounded-2xl border border-[#464B52] bg-[#0F1115] p-3 gap-3">
          {view !== 'asset-price' ? (
        ...
        <View
          className="rounded-2xl border border-[#21262d] bg-[#0F1115] px-2 py-3"
